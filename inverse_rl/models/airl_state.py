...
from inverse_rl.models.architectures import relu_net,sigmoid_airl_net,neg_linear_net
        ...
        with tf.variable_scope(name) as _vs:
            ...
            with tf.variable_scope('discrim') as dvs:
                ...
                with tf.variable_scope('reward') as rvs:
                    ...
                    self.myweights = tf.get_collection(tf.GraphKeys.TRAINABLE_VARIABLES, scope=rvs.name)
